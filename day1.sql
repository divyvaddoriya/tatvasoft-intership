...
VALUES ('Divy', 'Vaddoriya', 'Divy.Vaddoriya@gmail.com', NOW(), NULL, true);
...
INSERT INTO customer (first_name, last_name, email, created_date, updated_date, active) VALUES
  ...
  ('Divy', 'Vaddoriya', 'Divypatel@example.com', NOW(), NULL, false);
...
UPDATE customer
SET first_name = 'Divy', last_name = 'Patel', email = 'pateldivy@ldce.com'
WHERE customer_id = 7;
